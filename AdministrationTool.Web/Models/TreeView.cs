...
namespace AdministrationTool.Web.Models
{
    ...
    public class TreeView<T> : IHtmlString
    {
        ...
        {
            _html = html ?? throw new ArgumentNullException("html");
            _items = items;
        ...
        {
            _displayProperty = selector ?? throw new ArgumentNullException("selector");
            return this;
        }
        ...
        {
            _itemTemplate = itemTemplate ?? throw new ArgumentNullException("itemTemplate");
            return this;
        }
        /// <summary>  
        ...
        {
            _emptyContent = emptyContent ?? throw new ArgumentNullException("emptyContent");
            return this;
        }
        ...
        {
            _htmlAttributes = htmlAttributes ?? throw new ArgumentNullException("htmlAttributes");
            return this;
        }
        ...
        {
            _childHtmlAttributes = htmlAttributes ?? throw new ArgumentNullException("htmlAttributes");
            return this;
        }
